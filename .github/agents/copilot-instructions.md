...
## Active Technologies
- C# / .NET 10 + Existing `Narratoria.Pipeline` core; UI framework TBD (browser UI required for IndexedDB); JSON serialization (System.Text.Json) (003-pipeline-log-ui)
...
## Recent Changes
- 003-pipeline-log-ui: Added C# / .NET 10 + Existing `Narratoria.Pipeline` core; UI framework TBD (browser UI required for IndexedDB); JSON serialization (System.Text.Json)
