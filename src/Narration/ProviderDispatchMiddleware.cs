...
public sealed class ProviderDispatchMiddleware
{
        ...
        CancellationToken requestCancellationToken)
    {
        ...
        try
        {
            ...
            _stageMetadata?.ApplyProviderMetrics(context.SessionId, new Narratoria.Components.NarrationStageKind(Stage), promptTokens: null, completionTokens: tokens.Count, model: model);
