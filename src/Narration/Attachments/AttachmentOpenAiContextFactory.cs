...
public sealed class AttachmentOpenAiContextFactory : IAttachmentOpenAiContextFactory
{
    ...
    public AttachmentOpenAiContextFactory(
    ...
    public OpenAiRequestContext Create(TraceMetadata trace)
    {
        ...
        var logger = _loggerFactory.CreateLogger<AttachmentOpenAiContextFactory>();
