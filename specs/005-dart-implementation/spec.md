...
```
┌─────────────────────────────────────┐
│ ⚠️ The torch-lighter skill failed.  │
...
```
┌─────────────────────────────────────┐
│ 🔴 torch-lighter         FAILED    │
│    Error: TOOL_TIMEOUT             │
│    "Tool exceeded 30s timeout"     │
│    Retries: 3/3                    │
│    [View Logs] [Copy Error]        │
└─────────────────────────────────────┘
```
...
| §3 MVP | Implements Spec 001 protocol compliance, Spec 004 core skills |
| §4 Guidance | Implements Spec 002 execution algorithms |
| §5 Tech Stack | Constrained by Spec 003 skill requirements |
| §6 Structure | Organizes Spec 003 skill framework, Spec 004 skill implementations |
